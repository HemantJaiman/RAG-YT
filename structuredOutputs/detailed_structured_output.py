...
class Review(TypedDict):
    Summary: Annotated[str, "A brief summary of the review in detail"]
    Sentiment: Annotated[str, "The sentiment of the review, strictly either Positive or Negative"]
    Key_themes: Annotated[List[str], "Must write all the important Key points discussed"]
    Pros: Annotated[Optional[List[str]], "List all the positive points"]
    Cons: Annotated[Optional[List[str]], "List all the negative points"]  
